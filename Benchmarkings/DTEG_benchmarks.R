#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
# Differential translation analysis, benchmark ORFik (deltaTE) vs anota2seq
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
...
res.orfik_a.temp[abs(rfp) < 1.5 & abs(rna) < 1.5 & abs(te) < 1.5, Regulation := "No change"]
...

{
  ...
  stats <- data.table(column = c("ORFik", "anota2seq"))
  ...
  # DTEG genes
  stats[, DTEGs := c(nrow(res.orfik.baz), length(all_active))]
  ...
  stats[, DTEGs_overlap := c(ORFik_DTEG_over, anota_DTEG_over)]
  # DTEG genes (Translating)
  ORFik.translated <- res.orfik.baz$Regulation == "Translation"
  stats[, Translation := c(sum(ORFik.translated), length(translated))]
  ...
  stats[, Translation_overlap := c(ORFik_DTEG_over, anota_DTEG_over)]
  # DTEG genes (mRNA abundance)
  ORFik.abundance <- res.orfik.baz$Regulation == "mRNA abundance"
  stats[, mRNA_abundance := c(sum(ORFik.abundance), length(mrna_abundance))]
  ...
  stats[, mRNA_abundance_overlap := c(ORFik_DTEG_over, anota_DTEG_over)]
  # DTEG genes (buffering)
  ORFik.buffering <- res.orfik.baz$Regulation == "Buffering"
  stats[, Buffering := c(sum(ORFik.buffering), length(buffering))]
  ...
  stats[, Buffering_overlap := c(ORFik_DTEG_over, anota_DTEG_over)]
...
fwrite(stats, file = file.path(dirname(df.rfp$filepath[1]), "QC_STATS", "benchmark_stats_anota.csv"))
