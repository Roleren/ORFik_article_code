#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
# TCP-seq alignment (Bohlen et al)
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
# Article: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7447980/#mmc1
library(ORFik)
...
libs.to.remove <- "RNA-seq|eiF|Tunicamycin|Harringtonin|NIH3T3|crosslink|Untreated|ng/ml|3_80S|X_Bukau|5_|7_"
study.tcp <- study[-grep(pattern = libs.to.remove, ignore.case = FALSE, x = sample_title),]
libs.to.remove <- "40S|80S|eiF|Tunicamycin|Harringtonin|NIH3T3|crosslink|Untreated|ng/ml|3_80S|X_Bukau|5_|7_"
study.rna <- study[-grep(pattern = libs.to.remove, ignore.case = FALSE, x = sample_title),]
...
# TCP-seq alignment
alignment <-
  STAR.align.folder(fastq.dir,
                    output.dir = bam.dir, index.dir = index,
                    steps = "tr-co-ge", # (trim needed: adapters found, then genome)
                    adapter.sequence = "auto",
                    max.cpus = 80, trim.front = 0, min.length = 20)
# mRNA-seq alignment
alignment.rna <-
  STAR.align.folder(fastq.dir.rna,
                    output.dir = bam.dir.rna, index.dir = index,
                    steps = "tr-co-ge", # (trim needed: adapters found, then genome)
                    adapter.sequence = "small_RNA",
                    max.cpus = 80, trim.front = 0, min.length = 20, 
                    mismatches = 10)
...
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
# TCP-seq
create.experiment(paste0(alignment, "/aligned/"), exper = "sel_TCP_bohlen",
...
create.experiment(paste0(alignment.rna, "/aligned/"), exper = "zf_RNA_bohlen",
                  ...
                  txdb = paste0(annotation["gtf"], ".db"),
                  organism = organism,
                  pairedEndBam = study.rna$LibraryLayout == "PAIRED",
                  viewTemplate = FALSE)

# Now fix experiment table in libre office / excel if reading of experiment fails
library(ORFik)
...
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
ORFikQC(df); remove.experiments(df)
ORFikQC(df.rna); remove.experiments(df.rna)

#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
# Create heatmaps for TCP-seq
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
...
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
# P-shift 80S (not used)
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#

# shiftFootprintsByExperiment(df.LSU, accepted.lengths = 46:60)
# 
# heatMapRegion(df.LSU, region = "TIS", type = "pshifted", shifting = "5prime",
#               outdir = paste0(dirname(df$filepath[1]), "/QC_STATS/heatmaps/pshifted_80S/"))
# RiboQC.plot(df.LSU)
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
# TE-analysis
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
te.plot(df.LSU, df.rna)

# Remaining analysis found in figure2 script.
